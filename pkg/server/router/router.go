...
type Manager struct {
	routerHandlers     map[string]fasthttp.RequestHandler
...
func NewManager(conf *runtime.Configuration, serviceManager serviceManager, middlewaresBuilder middlewareBuilder, chainBuilder *middleware.ChainBuilder) *Manager {
	return &Manager{
		routerHandlers:     make(map[string]fasthttp.RequestHandler),
		serviceManager:     serviceManager,
...
func (m *Manager) BuildHandlers(rootCtx context.Context, entryPoints []string, tls bool) map[string]fasthttp.RequestHandler {
	entryPointHandlers := make(map[string]fasthttp.RequestHandler)
...
func (m *Manager) buildEntryPointHandler(ctx context.Context, configs map[string]*runtime.RouterInfo) (fasthttp.RequestHandler, error) {
...
func (m *Manager) buildHTTPHandler(ctx context.Context, router *runtime.RouterInfo, routerName string) (fasthttp.RequestHandler, error) {
...
func BuildDefaultFastHTTPRouter() fasthttp.RequestHandler {
