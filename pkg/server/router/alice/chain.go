...
type Constructor func(handler fasthttp.RequestHandler) (fasthttp.RequestHandler, error)
...
func (c Chain) Then(h fasthttp.RequestHandler) (fasthttp.RequestHandler, error) {
	if h == nil {
		h = nil
	}
